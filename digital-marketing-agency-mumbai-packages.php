...
<head>
    <title>Sagar Tech - Web Design Services in Mumbai</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-12">
                    <h2 class="iq-font-white" style="font-weight: bold;text-align: left;">Packages</h2>
        ...
        <section class="services-area"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 wow slideInDown" data-wow-duration="1.0s">
                        <div class="heading-title text-center">
                            <h1 class="iq-tw-6 small-title iq-font-dark" style="text-align:center;">Our Packages</h1>
                            <!--<p class="iq-mb-0 p-0" style="text-align: justify; font-size: 16px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates fuga quisquam laudantium magnam similique hic consequuntur. Aut, nihil velit! Voluptate maxime eius numquam pariatur et nobis aperiam iure consequuntur? Ex.</p>-->
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0.4s">
                        <div class="single-serviecs-block sdfdd">
                            ...
                            <i class="fas fa-search-location" style="font-size:60px"></i>
                            <h5 class="iq-tw-6 iq-mt-20 iq-font-black">
                                SMO + Local SEO
                            </h5>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="0.5s">
                        <div class="single-serviecs-block sdfdd">
                            ...
                            <i class="fas fa-search-location" style="font-size:60px"></i>
                            <img style='margin-top: -35px;' alt="seo" src="images/bg/NEWSEO.png">
                            <h5 class="iq-tw-6 iq-mt-20 iq-font-black fdgr">
                                SMO + Local SEO + SEO
                            </h5>
                            <!--<p style="color: black;margin-top: 20px;text-align: center;">SMO  + Local SEO</p>-->
                            <a href="tel:+919820133303"><button style="margin-top: 20px;"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="0.6s">
                        <div class="single-serviecs-block sdfdd">
                            <i class='fab fa-instagram' style='font-size:60px'></i>
                            <i class='fab fa-linkedin-in' style='font-size:60px'></i><br>
                            <i class="fas fa-ad" style="font-size:60px"></i>
                            <i class="fab fa-facebook" style="font-size:60px"></i>
                            <h5 class="iq-tw-6 iq-mt-20 iq-font-black">
                                SMO + SMM
                            </h5>
