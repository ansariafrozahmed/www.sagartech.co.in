...
<body>
    ...
    <div style="background:  radial-gradient(ellipse at center, #ff2828 0%, #000000 130%);" class="newsecondsection">
        <div class="left">
            <h2 style="line-height:40px;color:white">Expo Services</h2>
            ...
            <!-- <h3>Subtitle</h3> -->
            <p style="color:white">
                Expo is an open-source platform for building React Native applications. It simplifies the development process by providing a set of tools and services that streamline app creation, testing, and deployment. With Expo, developers can build cross-platform mobile apps using JavaScript and React without needing native code.
            </p>
    ...
    <div class="ourprocesssection">
        <div class="our-client-main-div">
            <h2>Benefits of <span style="font-family: 'Raleway', sans-serif;color: #ff0808">Expo</span></h2>
        </div>
        <div class="ourprocesssectiontwo">
            <div class="discover">
                <img src="./technologiesicons/expo/EasySetup.png" height="70px" alt="Easy Setup">
                <div class="headingggggg">Easy Setup</div>
                <p>Expo allows developers to start building React Native apps quickly without setting up native environments.</p>
            </div>
            <div class="discover">
                <img src="./technologiesicons/expo/LiveReload.png" height="70px" alt="Live Reload">
                <div class="headingggggg">Live Reload</div>
                <p>Supports live and hot reloading, enabling developers to see changes instantly without recompiling.</p>
            </div>
            <div class="discover">
                <img src="./technologiesicons/expo/CrossPlatform.png" height="70px" alt="Cross-Platform">
                <div class="headingggggg">Cross-Platform Development</div>
                <p>Write once and deploy on both iOS and Android without modifying the codebase.</p>
            </div>
            <div class="discover">
                <img src="./technologiesicons/expo/ExpoGo.png" height="70px" alt="Expo Go">
                <div class="headingggggg">Expo Go</div>
                <p>Test applications instantly on real devices using the Expo Go app, without needing emulators.</p>
            </div>
            <div class="discover">
                <img src="./technologiesicons/expo/OTAUpdates.png" height="70px" alt="OTA Updates">
                <div class="headingggggg">Over-the-Air Updates</div>
                <p>Deploy app updates instantly without requiring users to download new versions from the app store.</p>
            </div>
            <div class="discover">
                <img src="./technologiesicons/expo/Prebuilt.png" height="70px" alt="Pre-built APIs">
                <div class="headingggggg">Pre-built APIs</div>
                <p>Provides built-in APIs for camera, push notifications, and sensors, eliminating the need for custom native code.</p>
            </div>
        </div>
    </div>
    ...
    <div class="accordion">
        <div class="accordion-item">
            ...
            <div class="accordion-content">
                <p>Expo is a framework and platform for building universal React Native applications with minimal native code.</p>
            </div>
        </div>

        <div class="accordion-item">
            <h2>What are the advantages of using Expo over React Native CLI?</h2>
            <div class="accordion-content">
                <p>Expo simplifies development by providing built-in APIs, easy setup, and over-the-air updates, reducing the need for native configurations.</p>
            </div>
        </div>

        <div class="accordion-item">
            <h2>Can I use native code with Expo?</h2>
            <div class="accordion-content">
                <p>Expo supports native code via the EAS (Expo Application Services) but requires ejecting from the managed workflow to use custom native modules.</p>
            </div>
        </div>

        <div class="accordion-item">
            <h2>Does Expo support push notifications?</h2>
            <div class="accordion-content">
                <p>Yes, Expo provides a built-in push notification API for sending notifications to iOS and Android devices.</p>
            </div>
        </div>

        <div class="accordion-item">
            <h2>Is Expo good for production apps?</h2>
            <div class="accordion-content">
                <p>Yes, Expo is used by many production apps, but for advanced native customizations, developers may need to eject from Expo.</p>
            </div>
        </div>
    </div>
