                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <li ><a href="contact_block.php">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="iq-mb-0">
<h2 class="iq-font-white iq-tw-6">Event Details</h2>
</div>
</div>
<div class="col-lg-6 col-sm-12">
...
<section class="iq-action-blog  particles-bg" style="padding-bottom: 20px; padding-top: 20px;">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="index">Event</a></li>
    <li class="breadcrumb-item active" aria-current="page"><?php echo $res['act_name'];?></li>
  </ol>
</nav>
        </div>
    </div>
        ...
        <section class="iq-action-blog  particles-bg" style="margin-bottom: 70px">
            <div class="container">
                <div class="row">
                <div class="col-md-6">
                    <section class="event-slide slider">
                        <?php
                          $i = 1;
                          $img = mysqli_query($con,"SELECT * FROM images WHERE img_act_id = '$id'");
                          while($rows = mysqli_fetch_assoc($img)) {
                          ?>
                        <div class="slide">
                          <img src="backoffice/<?php echo $rows['img_tag'];?>" class="simg img-fluid" alt="...">
                        </div>
                        <?php
                        $i++;
                          }
                ...
                <div class="col-md-6">
                    <h5><?php echo $res['act_name'];?></h5>
                    <h6>Date: <?php echo $res['act_date'];?></h6> <hr> <br>
                    <p><?php echo $res['act_content'];?></p>
                </div>
            </div>
            </div>
        </section>
