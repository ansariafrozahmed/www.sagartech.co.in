...
<head>
    <title>See Our Banner Design Portfolio | Creative & Professional Work</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Explore our banner design portfolio, highlighting imaginative, polished, and striking designs. Ideal for companies looking for powerful graphic solutions!">
    <meta name="keywords" content="Banner Design Portfolio">
    <!-- Favicon -->
    <link rel="shortcut icon" href="../images/logoonly.jpg" />
    <link rel="canonical" href="https://sagartech.co.in/portfolio/banner">
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="website">
    <meta property="og:title" content="See Our Banner Design Portfolio | Creative & Professional Work">
    <meta property="og:description"
        content="Explore our banner design portfolio, highlighting imaginative, polished, and striking designs. Ideal for companies looking for powerful graphic solutions!">
    <meta property="og:url" content="https://sagartech.co.in/portfolio/banner">
...
<body>
    ...
    <section style="background-image: url('../portfolio-images/banner.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;" class="banner-content">
        ...
        <ul class="breadcrumbdiv">
            ...
            <li style="color: white;">Banner Designing</li>
        </ul>
    </section>
    ...
    <div class="fifthsection">
        <h2 style="text-transform:uppercase;">Our Designed <span style="color:#FF0808;">Banners</span></h2>
        <div class="logosec">
            <?php
      $imageUrls = [
          "../banner-mockups/1.webp",
          "../banner-mockups/2.webp",
          "../banner-mockups/3.webp",
          "../banner-mockups/4.webp",
          "../banner-mockups/5.webp",
          "../banner-mockups/6.webp",
          "../banner-mockups/8.webp",
          "../banner-mockups/9.webp",
          "../banner-mockups/10.webp",
          "../banner-mockups/11.webp",
          "../banner-mockups/12.webp",
          "../banner-mockups/13.webp",
          "../banner-mockups/14.webp",
          "../banner-mockups/16.webp",
      ];
