...
<head>
    <title>Restaurants Website Design Portfolio | Stunning Dining Websites</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Explore our restaurant's website design portfolio, which includes attractive and useful dining websites. Ideal for promoting your restaurant and drawing in new customers. View more!
">
    <meta name="keywords" content="Restaurants Website Design Portfolio">
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?= WEB_URL ?>images/logoonly.jpg" />
    <link rel="canonical" href="https://sagartech.co.in/portfolio/restaurants-website">
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Restaurants Website Design Portfolio | Stunning Dining Websites">
    <meta property="og:description"
        content="Explore our restaurant's website design portfolio, which includes attractive and useful dining websites. Ideal for promoting your restaurant and drawing in new customers. View more!">
    <meta property="og:url" content="https://sagartech.co.in/portfolio/restaurants-website">
...
<body>
    ...
    <section style="background-image: url('../portfolio-images/banner.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;" class="banner-content">
        ...
        <ul class="breadcrumbdiv">
            ...
            <li><a style="color: white;">Restaurants Website Portfolio</a></li>
        </ul>
    </section>

    <div id="Builders" class="content-div">
        <h2 style="text-align: center; font-weight: 600; padding: 10px; font-size: 30px;">Our Restaurants Website portfolio</h2>
        <hr>
        <div class="maincontent">
    <?php
    // Define an array of restaurants data
    ...
    foreach ($restaurantsData as $item) {
