...
<head>
    <title>Human Resource Website Design Portfolio | Modern Recruitment Websites</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="View our human Recruitment website design portfolio, which includes modern and well-designed recruitment websites. ideal for bringing human resource for your work. View more!
">
    <meta name="keywords" content="Human resource Website Design Portfolio">
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?= WEB_URL ?>images/logoonly.jpg" />
    <link rel="canonical" href="https://sagartech.co.in/portfolio/human-resource">
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Human Resource Website Design Portfolio | Modern Recruitment Websites">
    <meta property="og:description" content="View our human Recruitment website design portfolio, which includes modern and well-designed recruitment websites. ideal for bringing human resource for your work. View more!
">
    <meta property="og:url" content="https://sagartech.co.in/portfolio/human-resource">
...
<body>
    ...
    <section
        ...
        <ul class="breadcrumbdiv">
            ...
            <li><a style="color: white;">Human Resource Websites Portfolio</a></li>
        </ul>
    </section>

    <div id="Builders" class="content-div">
        <h2 style="text-align: center; font-weight: 600; padding: 10px; font-size: 30px;">Our Human Resource Websites
            Portfolio</h2>
        <hr>
        <div class="maincontent">
            <?php
            // Define an array of interior data
            $HumanResourceData = array(
                array(
                    "name" => "Yovant Recruitment",
                    "imgSrc" => "../portfolio-mockups/humanresource/yovant-webite-mockup.webp",
                    ...
                    "link" => "https://yovantrecruitment.com/"
                )
            );

            // Loop through the interior data and generate HTML for each item
            foreach ($HumanResourceData as $item) {
