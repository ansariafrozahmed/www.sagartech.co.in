...
<head>
    <title>Our Logistics Portfolio - Sagar Tech Technical Solutions</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="content-div">
        ...
        <div class="maincontent">
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/logistics/adhiklogistics.webp" alt="Adhik Logistics">
                </div>
            ...
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/logistics/amarclearing.webp" alt="Amar Clearing">
                </div>
                <div class="content-text">
                    <h2>Amar Clearing</h2>
                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, inventore est? Ipsum magni sunt alias voluptas deleniti in explicabo fuga amet.</p> -->
            ...
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/logistics/amclogistics.webp" alt="Amca Logistics">
                </div>
                <div class="content-text">
                    <h2>Amca Logistics</h2>
                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, inventore est? Ipsum magni sunt alias voluptas deleniti in explicabo fuga amet.</p> -->
                </div>
            </div>
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/logistics/index.webp" alt="Index">
                </div>
                <div class="content-text">
                    <h2>Index</h2>
                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, inventore est? Ipsum magni sunt alias voluptas deleniti in explicabo fuga amet.</p> -->
            ...
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/logistics/marsairocean.webp" alt="Mars Air Ocean">
                </div>
                <div class="content-text">
            ...
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/logistics/pacematters.webp" alt="Pace Matters">
                </div>
                <div class="content-text">
                    <h2>Pace Matters</h2>
                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, inventore est? Ipsum magni sunt alias voluptas deleniti in explicabo fuga amet.</p> -->
