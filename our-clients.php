...
background: linear-gradient(0deg, rgba(162,0,0,1) 35%, rgba(255,8,8,1) 100%); */
    ...
    .second-section-client {
        padding:50px 100px;
        text-align:center;
    }
    .second-section-client h2 {
        font-size:45px;
        font-weight:600;
        margin-bottom:20px;
    }
...
<body>
    ...
    <div class="herosectionnew">
        <h1 style="text-transform:uppercase;">Our Clients</h1>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        "client-logos/verify8.png",
        "client-logos/dontquitventure.png",
        "client-logos/nooralsalama.png",
        //"client-logos/bebegiro.png",
