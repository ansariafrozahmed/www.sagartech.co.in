...
<head>
    ...
    <meta property="og:url" content="https://sagartech.co.in/static-website-development-company-in-mumbai">
    <meta property="og:image" content="https://sagartech.co.in/images/OG-Images/static.png">
    <meta property="og:description"
        content="Best static website development and design company in Mumbai creates pages in real time,adapting to static features like screen size and device.">
    <!-- Favicon -->
    <link rel="canonical" href="https://sagartech.co.in/static-website-development-company-in-mumbai" />
...
<body>
    ...
    <div class="fourth-ecom-sec">
        <span class="texttt">
            Sagar Tech Technical Solution offers static website development services to help you take your online
    ...
    <div class="sixth-ecom-sec">
        <h2>Platform Used by Sagar Tech Technical Solution for Static Website Development</h2>
    ...
    <div class="seventh-ecom-sec">
        <div class="ecom-head">
            <h2 style="text-align: center;">Our Static Website Development Process</h2>
            <!-- <span>
    ...
    <div class="eight-ecom-sec">
        ...
        <div class="eight-bottom">
            ...
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/responsive-design.webp" alt="Static Website">
                <h2>Responsive Design</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/money.webp" alt="Static Website">
                <h2>Database Integration</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/api.webp" alt="Static Website">
                <h2>User Authentication & Management</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/promo.webp" alt="Static Website">
                <h2>Static Content Generation</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/wishlist.webp" alt="Static Website">
                <h2>Search Engine Optimization</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/cart.webp" alt="Static Website">
                <h2>Integration with Third-Party Services</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/rate.webp" alt="Static Website">
                <h2>Scalability & Performance</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/search-engine-optimization.webp" alt="Static Website">
                <h2>Search Engine Optimized</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/report.webp" alt="Static Website">
                <h2>Reporting Tools</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/data-collection.webp" alt="Static Website">
                <h2>Security Features</h2>
            </div>
            <!-- ------------ -->
            <div class="eight-card">
                <img src="./icons/scale.webp" alt="Static Website">
