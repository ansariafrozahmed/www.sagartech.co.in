...
<main class="main-wrapper bg-white">
    <div class="max-w-[1500px] mx-auto p-4 md:p-8 lg:p-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6 pt-12 pb-6 md:py-12">
        <div class="space-y-1">
                ...
                <div role="listitem" class="item">
                    <div class=" h-screen w-full">
                        <video class="lazy-video" preload="none" loop muted playsinline class="h-full w-full object-cover">
                            ...
                            <source src="<?php WEB_URL ?>video/home/thaigerDesktop.mp4" type="video/mp4" loading="lazy" media="(min-width: 769px)">
                        </video>
                    </div>
                </div>
                <div role="listitem" class="item">
