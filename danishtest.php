    ...
    <div id="rev_slider_116_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="bg-effect" data-source="gallery" style=>
        ...
        <div id="rev_slider_116_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.8">
            <ul class="icon-none">
                ...
                <!-- SLIDE  -->
                <!--<li data-index="rs-389" data-transition="random-static,random-premium,random"-->
                ...
                <!--    data-thumb="images/header/appdevelopment.jpg" data-rotate="0,0,0,0" data-saveperformance="off"-->
                <!--    class="b1-video" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4=""-->
                <!--    data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""-->
                <!--    data-description="">-->
                <!-- MAIN IMAGE -->
                <!--    <img src="images/header/appdevelopment.jpg" alt="app developers in mumbai" title = "app developers in mumbai" data-bgposition="center center" data-bgfit="cover"-->
                <!--        data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>-->
                <!-- LAYERS -->
                <!--</li>-->
                <!-- SLIDE  -->
                <!--<li data-index="rs-390" data-transition="random-static,random-premium,random"-->
                <!--    data-slotamount="default,default,default,default" data-hideafterloop="0"-->
                <!--    data-hideslideonmobile="off" data-randomtransition="on"-->
                <!--    data-easein="default,default,default,default" data-easeout="default,default,default,default"-->
                <!--    data-masterspeed="default,default,default,default"-->
                ...
                <!-- LAYERS -->
                <!--</li>-->
                <!--<li data-index="rs-399" data-transition="random-static,random-premium,random"-->
                <!--    data-slotamount="default,default,default,default" data-hideafterloop="0"-->
                <!--    data-hideslideonmobile="off" data-randomtransition="on"-->
                <!--    data-easein="default,default,default,default" data-easeout="default,default,default,default"-->
                <!--    data-masterspeed="default,default,default,default"-->
                <!--    data-thumb="images/header/accounts.jpg" data-rotate="0,0,0,0" data-saveperformance="off"-->
                <!--    class="b1-video" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4=""-->
                <!--    data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""-->
                <!--    data-description="">-->
                <!-- MAIN IMAGE -->
                <!--    <img src="images/header/accounts.jpg" alt="accounting service in mumbai" title="accounting service in mumbai" data-bgposition="center center" data-bgfit="cover"-->
                <!--        data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>-->
                <!-- LAYERS -->
                <!--</li>-->
                <!--<li data-index="rs-400" data-transition="random-static,random-premium,random"-->
                <!--    data-slotamount="default,default,default,default" data-hideafterloop="0"-->
                <!--    data-hideslideonmobile="off" data-randomtransition="on"-->
                <!--    data-easein="default,default,default,default" data-easeout="default,default,default,default"-->
                <!--    data-masterspeed="default,default,default,default"-->
                <!--    data-thumb="images/header/graphicdesign.jpg" data-rotate="0,0,0,0" data-saveperformance="off"-->
                <!--    class="b1-video" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4=""-->
                <!--    data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""-->
                <!--    data-description="">-->
                <!-- MAIN IMAGE -->
                <!--    <img src="images/header/graphicdesign.jpg" alt="graphic designers in mumbai" title="graphic designers in mumbai" data-bgposition="center center" data-bgfit="cover"-->
                <!--        data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>-->
                <!-- LAYERS -->
                <!--</li>-->
                <!--<li data-index="rs-500" data-transition="random-static,random-premium,random"-->
                <!--    data-slotamount="default,default,default,default" data-hideafterloop="0"-->
                <!--    data-hideslideonmobile="off" data-randomtransition="on"-->
                <!--    data-easein="default,default,default,default" data-easeout="default,default,default,default"-->
                <!--    data-masterspeed="default,default,default,default"-->
                <!--    data-thumb="images/header/isoconsultants.jpg" data-rotate="0,0,0,0" data-saveperformance="off"-->
                <!--    class="b1-video" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4=""-->
                <!--    data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""-->
                <!--    data-description="">-->
                <!-- MAIN IMAGE -->
                <!--    <img src="images/header/isoconsultants.jpg" alt="iso consultants in mumbai" title="iso consultants in mumbai" data-bgposition="center center" data-bgfit="cover"-->
                <!--        data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>-->
                <!-- LAYERS -->
                <!--</li>-->
                <!--<li data-index="rs-600" data-transition="random-static,random-premium,random"-->
                <!--    data-slotamount="default,default,default,default" data-hideafterloop="0"-->
                <!--    data-hideslideonmobile="off" data-randomtransition="on"-->
                <!--    data-easein="default,default,default,default" data-easeout="default,default,default,default"-->
                <!--    data-masterspeed="default,default,default,default"-->
                <!--    data-thumb="images/header/localseo.jpg" data-rotate="0,0,0,0" data-saveperformance="off"-->
                <!--    class="b1-video" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4=""-->
                <!--    data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""-->
                <!--    data-description="">-->
                <!-- MAIN IMAGE -->
                <!--    <img src="images/header/localseo.jpg" alt="local seo service in mumbai" title="local seo service in mumbai" data-bgposition="center center" data-bgfit="cover"-->
                <!--        data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>-->
                <!-- LAYERS -->
                <!--</li>-->
            </ul>
            ...
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-md-3">
                    ...
                    <div class="col-lg-4 mb-4 web-services wow fadeInDown" data-wow-duration="1.0s" style="">
                        <div class="cardz">
                            <a href="digital-marketing-service">
                                <i class='fas fa-bullhorn' style="font-size: 120px;"></i>
                                <div class="card-body">
                                    <h4 class="card-title text-center iq-tw-6">Digital Marketing</h4>
                    ...
                    <div class="col-lg-4 mb     -4 web-services wow fadeInUp" data-wow-duration="1.0s" style="margin-bottom:25px">
                        <div class="cardz services-hover">
                            <a href="bulk_sms_service_providers_in_mumbai">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title text-center services-onhover iq-tw-6">Bulk SMS Service</h4>
                                    <p class="card-text services-onhover" style="text-align:center !important;"></p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4 mb-4 web-services wow fadeInDown" data-wow-duration="1.0s">
                        <div class="cardz">
                            <a href="graphic">
                                <i class='far fa-object-group' style='font-size:120px'></i>
                                <div class="card-body">
                                    <h4 class="card-title text-center iq-tw-6">Graphic Designing</h4>
                                    <p class="card-text" style="text-align:center !important;"></p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4 mb-4 web-services wow fadeInUp" data-wow-duration="1.0s">
                        <div class="cardz services-hover">
                            <a href="#">
                                <i class='fas fa-mobile-alt services-onhover' style='font-size:120px'></i>
                                <div class="card-body">
                                    <h4 class="card-title text-center services-onhover iq-tw-6">App Development</h4>
                                    <p class="card-text services-onhover" style="text-align:center !important;"></p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4 mb-4 web-services wow fadeInDown" data-wow-duration="1.0s" style="">
                        <div class="cardz ">
                            <a href="#">
                                <i class="fa fa-pencil-square-o" style="font-size:120px"></i>
                                <div class="card-body">
                                    <h4 class="card-title text-center iq-tw-6">ISO Consulting</h4>
                                    <p class="card-text" style="text-align:center !important;"></p>
                                </div>
                            </a>
                        </div>
...
<!--            <h3 class="iq-font-dark iq-tw-6 wow fadeIn" data-wow-duration="1.0s">Our Vision</h3>-->
<!--            <img src="images/bg/vision12.png" class="img-fluid rimg wow slideInUp" data-wow-duration="1.0s" alt="vision">-->
<!--        </div>-->
<!--        <div class="text-center">-->
<!--            <div class="bubble text-justify" style="text-justify: distribute;">-->
<!--                <blockquote>-->
<!--                <strong>-->
<!--                To become the most successful and largest MNC.-->
<!--                </strong> -->
<!--                </blockquote>-->
<!--                <div></div>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="text-center text-justify" style="text-justify: distribute;">-->
<!--            <h3 class="iq-font-dark iq-tw-6 wow fadeIn" data-wow-duration="1.0s" data-wow-delay="3s">Our Mission</h3>-->
<!--            <img src="images/bg/mission12.png" class="img-fluid rimg wow bounceIn" data-wow-duration="1.0s" data-wow-delay="3s" alt="mission">-->
<!--        </div>-->
<!--        <div class="text-center">-->
<!--            <div class="bubble text-justify" style="text-justify: distribute;">-->
<!--                <blockquote> -->
<!--                <strong>    -->
<!--                To give employment to maximum unemployed and skillful persons.-->
<!--                </strong>-->
<!--                </blockquote>-->
<!--            </div>-->
<!--        </div>-->
