...
<body>
  ...
  <div class="new_ecom_style_main">
      ...
      <div class="new_ecom_style_card_container">
        ...
        <div id="advanced-app" class="new_ecom_style_package-container">
          <div
            ...
            class="new_ecom_style_package-cards"></div>
        </div>
      </div>
    </div>
    ...
    <div class="new_ecom_style_platforms_container">
      ...
      <div class="new_ecom_style_platforms_inner">
        <div class="new_ecom_style_platforms_inner_card">
        ...
        <div class="new_ecom_style_platforms_inner_card">
          <img src="./icons/react.png" alt="next js">
        </div>
        <div class="new_ecom_style_platforms_inner_card">
          <img src="./icons/react-native.svg" alt="next js">
        </div>
        <div class="new_ecom_style_platforms_inner_card">
          <img src="./icons/flutter.png" alt="next js">
        </div>
        <div class="new_ecom_style_platforms_inner_card">
  ...
  <script>
    const basicPackages = [{
        ...
        heading: "Shopify",
        subheading: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veritatis.",
