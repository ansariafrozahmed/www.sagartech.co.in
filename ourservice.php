...
<style>
    ...
    .our-service-card {
        ...
        padding: 50px 25px;
        border-radius: 20px;
        transition: all .2s ease-in-out; /* Transition applied for both hover-in and hover-out */
        cursor: pointer;
    }
    ...
    .our-service-content.show-more {
        display: block; /* Show content when the class is added */
    }

    .our-service-card {
        overflow: hidden; /* Ensure no overflow on the card */
