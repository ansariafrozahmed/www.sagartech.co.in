...
<head>
    <title>Social Media Post Design Services in India | Build Your Brand</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <!-- custom -->
    <link rel="stylesheet" href="css/social-media-post.css">
...
<body>
    ...
    <div class="herosectionnew" style="background-image: url(./banner/background.webp);">
        ...
        <div class="herobuttonsnew">
            ...
            <a href="portfolio_old" class="buttonsss">View Portfolio</a>
        </div>
    </div>
    ...
    <div class="secondsection">
        <div class="left">
            ...
            <div class="herobuttonsnew">
                <a href="digital-marketing-agency-mumbai-packages" class="buttonsss">Our Packages</a>
            </div>
        </div>
        <div class="right">
            <img src="./social-media-mockup/1.webp" alt="">
        </div>
    </div>
    ...
    <div class="typesofsection">
        ...
        <div class="herobuttonssssnew" style="margin-top: 15px; padding: 10px;">
            <a href="digital-marketing-agency-mumbai-package" class="buttonsss">POST DESIGN PACKAGE</a>
        </div>
    </div>
    ...
    <!-- <div class="thirdsection">
        ...
        <p>As a premium logo design company in India, our expert logo designers have made unique logos for small businesses as well as large enterprises worldwide. Our logo designs span multiple industries such as, real estate, education, financial institutions, food, hospitality, information technology, fashion and more. Our custom logo design services are available in different packages to suit the needs of every business. Get in touch with us for a detailed proposal on your logo requirement and to work with the best logo designers in the industry.</p> -->
    <!-- <div class="videosection">
            <iframe src="https://www.youtube.com/embed/tgbNymZ7vqY">
            </iframe>
        </div> -->
    <!-- <div class="herobuttonssssnew">
            <a href="#" class="buttonsss">Talk To Us</a>
            </div> -->
    <!-- </div> -->
    ...
    <div class="fifthsection">
        <h2>Our Social Media <span style="color:#FF0808">Post Design Portfolio</span></h2>
        <div class="logosec">
            <div class="imgdiv">
                <img src="./social-media-mockup/1.webp" alt="">
            </div>
            <div class="imgdiv">
                <img src="./social-media-mockup/2.webp" alt="">
            </div>
            <div class="imgdiv">
                <img src="./social-media-mockup/3.webp" alt="">
            </div>
            <!-- <div class="imgdiv">
                <img src="./social-media-mockup/4.webp" alt="">
            </div> -->
            <div class="imgdiv">
                <img src="./social-media-mockup/5.webp" alt="">
            </div>
            <div class="imgdiv">
                <img src="./social-media-mockup/6.webp" alt="">
            </div>
        </div>
    </div>
