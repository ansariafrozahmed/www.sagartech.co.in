...
<body>
    ...
    <?php
    include("include/new-services/new-shopify-website/landingSection.php"); ?>
    <?php
    include("include/new-services/new-shopify-website/gsapVideoSection.php"); ?>
    <?php
    include("include/new-services/new-shopify-website/servicesProvided.php"); ?>
    <?php
    include("include/new-services/new-shopify-website/whychooseUs.php"); ?>
    <?php
    include("include/new-services/new-shopify-website/servicePlanTypes.php"); ?>
    <?php
    include("include/new-services/new-shopify-website/whyYourBusiness.php"); ?>
    <?php
    include("include/new-services/new-shopify-website/shopifyShowcaseCard.php"); ?>
    <div class="lg:px-8">
        <?php
