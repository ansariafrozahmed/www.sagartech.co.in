...
<body>
    ...
    <div class="content-div">
        <h2 style="text-align: center; font-weight: 600; padding: 10px; font-size: 30px;">Our Travels Website portfolio</h2>
        <hr>
        <div class="maincontent">
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/travel/alhusaini.webp" alt="Al Husaini">
                </div>
            ...
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/travel/globexmanpower.webp" alt="Globe X Man Power">
                </div>
                <div class="content-text">
                    <h2>Globe X Man Power</h2>
                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, inventore est? Ipsum magni sunt alias voluptas deleniti in explicabo fuga amet.</p> -->
                </div>
            </div>
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/travel/riyazint.webp" alt="Riyazint">
                </div>
                <div class="content-text">
            ...
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/travel/zubair.webp" alt="Zubair">
                </div>
                <div class="content-text">
                    <h2>Zubair</h2>
                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, inventore est? Ipsum magni sunt alias voluptas deleniti in explicabo fuga amet.</p> -->
