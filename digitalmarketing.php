...
<head>
        <title>Sagar Tech - Digital marketing agency in Mumbai</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <li ><a href="contact_block">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-sm-12">
                <div class="iq-mb-0">
                    <h1 class="iq-font-white iq-tw-6">Digital Marketing</h1>
                </div>
            </div>
            <div class="col-lg-6 col-sm-12">
...
<!--=================================Action Box -->
        <section class="iq-action-blog overview-block-pt particles-bg" style="margin: 20px 0px 70px 0px;">
            <div class="container">
                <div class="row">
                 ...
                 <div class="seo-services">
                    <h1 class="text-center">Digital Marketing Agency in South Mumbai</h1>
            ...
            <div class="row">
              <div class="col-md-12">
                <h4 align="center">Digital Marekting Platforms</h4>
              </div>
              
            </div>

            <div class="row" style="padding: 30px 0px;">
              <div class="col-md-3 col-sm-6 background-design">
                <div class="overlay">
                <h4 style="color:white; ">Blogs</h4>
                </div>
                <h4 style="color:white;">Blogs</h4>
                <img src="images/blogging-blur-business-communication-261662.jpg" alt="" class="image" style="width:100%">
              ...
              <div class="col-md-3 col-sm-6 background-design">
                ...
                <h4 style="color:white;">facebook</h4>
                <img src="images/access-app-application-apps-267399.jpg" alt="" class="image" style="width:100%">
              
              </div>
              <div class="col-md-3 background-design">
                <div class="overlay">
                <h4 style="color:white;">Instagram</h4>
                </div>
                 <h4 style="color:white;">Instagram</h4>
                <img src="images/neonbrand-nZJBt4gQlKI-unsplash.jpg" alt="" class="image" style="width:100%">
              
              </div>
              <div class="col-md-3 background-design">
                <div class="overlay">
                <h4 style="color:white;">Google Adsense</h4>
                </div>
                 <h4 style="color:white;">Google Adsense</h4>
                <img src="images/black-samsung-tablet-display-google-browser-on-screen-218717.jpg" alt="" class="image" style="width:100%">
