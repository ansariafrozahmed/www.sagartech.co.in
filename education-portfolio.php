...
<body>
    ...
    <div class="content-div">
        <h2 style="text-align: center; font-weight: 600; padding: 10px; font-size: 30px;">Our Education Website portfolio</h2>
        <hr>
        <div class="maincontent">
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/education/capdiw.webp" alt="Capdiw">
                </div>
            ...
            <div class="maincontent-inner">
                <div class="imgdiv">
                    <img src="./portfolio-mockups/education/expert4expat.webp" alt="Expert 4 Expat">
                </div>
                <div class="content-text">
