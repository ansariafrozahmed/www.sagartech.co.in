...
<div class="">
    ...
    <h2 class="heading-all md:text-5xl text-3xl text-center ">
        From the CEO’s Desk
    </h2>
...
<!-- SECTION 3 -->
<div class=" lg:h-[600px] flex lg:flex-row flex-col max-sm:items-center ">
    <div class=" flex justify-center items-center lg:w-1/2 py-20 w-full bg-[linear-gradient(163deg,_rgba(250,246,243,1)_14%,_rgba(246,213,229,1)_37%,_rgba(253,43,33,1)_99%)]">
        <div class="max-sm:px-4">
            ...
            <div class="mt-5">
                <p class="content-all text-white lg:px-20 text-center">
                    <span class="text-red-600 font-bold">"</span> if we do not give our clients the desired results they expect and for which they have approached us, then our income will not be appropriate.<span class="text-red-600 font-bold"> "</span>
                </p>
                <div class="mt-6 flex justify-center">
                    <div class="flex flex-col items-center space-x-3">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-red-700 flex gap-1 items-center text-sm font-bold heading-all">
                                Ubaid Saudagar - <span class="text-white font-normal ">CEO, Sagar Tech</span>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div
        class="lg:w-1/2 w-full bg-cover bg-center bg-no-repeat flex justify-center items-center bg-gray-200"
        style="background-image: url('ceobg.webp');">
