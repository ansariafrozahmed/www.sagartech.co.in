...
<div class="bg-[radial-gradient(circle,_rgba(111,0,0,1)_0%,_rgba(48,0,0,1)_100%)] md:py-10 py-10 px-4">
    <h4 class="flex justify-center items-center gap-1   mx-auto" data-aos="fade-up">
        <!-- <div class="">
    ...
    <div class="mt-5">
        <h1 class=" text-[50px] max-w-[800px] text-[#242424] mx-auto text-center leading-[1.1]  tracking-[0px] font-light " data-aos="fade-up"><span class="text-white heading-all ">Sagar Tech </span> <span class="text-gray-100 inline-block text-center heading-all">Technical Solutions</span></h1>
        <div class="flex justify-center">

            <h3 class="text-[20px] lg:text-[24px] leading-[1.15] max-w-[600px] lg:max-w-[700px] font-[400]    heading-all text-white" data-aos="fade-up">Think Red, Think Sagar Tech</h3>
        </div>
        <p class="text-sm mt-3 text-red-300 text-[13.5px] font-light md:px-40  text-center tracking-wide content-all !my-7" data-aos="fade-up">
