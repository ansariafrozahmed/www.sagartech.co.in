    ...
    <div class="">
        ...
        <div class="flex md:flex-row flex-col justify-between gap-10">
                ...
                <div class=" w-full">
                    <h3 class="text-[28px] lg:text-[36px] leading-[1.15] max-w-[600px] lg:max-w-[700px] font-[400] mt-3 text-[#242424] heading-all " data-aos="fade-up">Digital Workspace <br> Platform <span class="text-[#ff0808]">Sagar Tech</span></span></h2>
                        ...
                        <div class="mt-5 hover:!scale-105 transition-all duration-300 ease-out">
                            <a href="/contact" class="text-sm font-medium border border-black  text-gray-900 rounded-md px-5 py-2 " data-aos="fade-up">
                                Contact Us
                            </a>
                        </div>
                </div>
            ...
            <div class="md:w-[70%] w-full grid md:grid-cols-2 grid-cols-1 gap-3">
                <div class="border border-gray-100 rounded-xl p-5 bg-[#fafafa]" data-aos="fade-up">
                    <div class="flex items-center gap-2.5">

                        <img src="web-programming.png" alt="" class="w-6 pb-3">
                ...
                <div class="border border-gray-100 rounded-xl p-5 bg-[#fafafa]">
                    <div class="flex items-center gap-2.5">
                        <img src="social-media1.png" alt="" class="w-6 pb-3">
                ...
                <div class="border border-gray-100 rounded-xl p-5 bg-[#fafafa]">
                    <div class="flex items-center gap-2.5">
                        <img src="seo1.png" alt="" class="w-6 pb-3">
                ...
                <div class="border border-gray-100 rounded-xl p-5 bg-[#fafafa]">
                    <div class="flex items-center gap-2.5">
                        ...
                        <img src="graphic1.png" class="w-6 pb-3" alt="">
                        <h3 class=" text-[20px] lg:text-[24px] leading-[1.15] max-w-[600px] lg:max-w-[700px] font-[400] !pb-3 " data-aos="fade-up">Graphic Designer Team</h3>
