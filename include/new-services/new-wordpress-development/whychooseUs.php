...
<div class="lg:!py-16 py-10 px-4  mx-auto relative lg:px-20 hidden  overflow-hidden lg:block bg-[url(new-images/sticky-bg4.webp)] bg-cover bg-center ">
    ...
    <div class="" id="pinned-text-section">
        <h2 class="text-[35px] lg:text-[50px] text-white max-w-[850px]  leading-[1.05] font-[400] " id="reveal-text">
            Why Brands Trust Us <br class="max-sm:hidden"> for Custom WordPress Development
        ...
        <div class="max-sm:space-y-5">
            ...
            <div id="tilta1-animation-container">
                <div class="glass-dark lg:m-6 max-sm:text-justify border border-gray-800 rounded-3xl p-7 max-w-[450px] w-full bg-black" id="tilta1-animation-section">
                    <div class="text-gray-300 text-3xl mb-4">
                        ...
                        <h2 class="text-[20px] lg:text-[22px] leading-[1.15] mt-2 font-[400] text-white">WordPress Expertise</h2>
                    </div>
                    <p class="text-[13.5px] font-light tracking-wide text-gray-400">
                        We specialize in custom WordPress development — from responsive themes to tailored plugins and complex CMS solutions.
                    </p>
                </div>
            </div>
            ...
            <div id="tilt1-animation-container">
                <div class="glass-dark lg:m-6 max-sm:text-justify border border-gray-800 rounded-3xl p-7 max-w-[450px] w-full bg-black" id="tilt1-animation-section">
                    <div class="text-gray-300 text-3xl mb-4">
                        <img src="new-icons/white-icons/portfolio.png" class="w-12 mb-3" alt="">
                        <h2 class="text-[20px] lg:text-[22px] leading-[1.15] mt-2 font-[400] text-white">Custom Site Portfolio</h2>
                    </div>
                    <p class="text-[13.5px] font-light tracking-wide text-gray-400">
                        Explore our WordPress portfolio — fully customized websites built to reflect brand identity, performance, and usability.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:mt-16 max-sm:space-y-5">
            ...
            <div id="tilt4-animation-container">
                <div class="glass-dark lg:m-6 max-sm:text-justify border border-gray-800 rounded-3xl p-7 max-w-[450px] w-full bg-black" id="tilt4-animation-section">
                    <div class="text-gray-300 text-3xl mb-4">
                        ...
                        <h2 class="text-[20px] lg:text-[22px] leading-[1.15] mt-2 font-[400] text-white">Scalable Architecture</h2>
                    </div>
                    <p class="text-[13.5px] font-light tracking-wide text-gray-400">
                        We build with future growth in mind — modular and scalable WordPress frameworks designed for evolving business needs.
                    </p>
                </div>
            </div>
            ...
            <div id="tilt3-animation-container">
                <div class="glass-dark lg:m-6 max-sm:text-justify border border-gray-800 rounded-3xl p-7 max-w-[450px] w-full bg-black" id="tilt3-animation-section">
                    <div class="text-gray-300 text-3xl mb-4">
                        <img src="new-icons/white-icons/seo/seo2.png" class="w-12 mb-3" alt="">
                        <h2 class="text-[20px] lg:text-[22px] leading-[1.15] mt-2 font-[400] text-white">Maintenance & SEO Support</h2>
                    </div>
                    <p class="text-[13.5px] font-light tracking-wide text-gray-400">
                        We offer continuous maintenance, plugin updates, performance optimization, and SEO strategies to keep your site competitive.
                    </p>
                </div>
            </div>
        </div>
