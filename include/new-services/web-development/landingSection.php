<div class="lg:pb-16 pb-10 lg:px-20 px-4">
    <h1 class=" lg:text-7xl text-3xl lg:text-start text-center  tracking-wide md:!leading-[85px] max-w-[1000px] w-full text-[#242424] ">
...
<div class="h-[100vh] w-full bg-fixed bg-center bg-cover bg-no-repeat " style="background-image: url('new-images/attached-bg.webp');">
</div>