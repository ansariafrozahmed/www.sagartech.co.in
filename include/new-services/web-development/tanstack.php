<div class="lg:px-20 lg:pb-16 pb-10 px-4">
    <h2 class="text-[28px] lg:text-[40px] leading-[1.15] max-w-[600px] lg:max-w-[700px] mx-auto text-center font-[400] text-[#242424]"><span class="text-red-500">Tech Stack</span> We Use</h2>
