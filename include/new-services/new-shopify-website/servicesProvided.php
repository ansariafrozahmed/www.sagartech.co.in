        ...
        <div class="lg:px-20 px-4 lg:py-16 py-10 flex lg:flex-row flex-col items-center justify-between gap-10">
            ...
            <div class="lg:w-[50%] w-full text-area">
                <h3 class="text-title text-[28px] lg:text-[40px] leading-[1.15] font-[400] max-sm:text-white md:text-start text-center max-w-[700px]">
                    We specialize in building high-performing, user-friendly
                    <span class="text-title">Shopify websites</span> tailored to elevate your brand and boost sales.
                </h3>

                <p class="text-[13.5px] text-gray-400 mt-5 ">
                    From design to launch, we craft seamless Shopify <br class="max-sm:hidden"> experiences that drive conversions.
                </p>
                <!-- For Mobile -->
                <!-- Tags -->
                ...
                <div class="flex gap-10 items-center max-sm:justify-center mt-10 stat-area">
                    <div>
                        ...
                        <div class="text-sub text-[13.5px] !text-gray-400">Shopify Website Experts</div>
                    </div>
                    <div>
                        <div class="text-title text-[28px] lg:text-[40px] font-[400]  max-sm:text-white">50+</div>
                        <hr class="my-2 border-gray-300">
            ...
            <div class="lg:w-[50%] w-full relative  rounded-3xl p-5 max-sm:hidden block">
                ...
                <div class="tag-item absolute top-10 border !border-gray-600 !text-gray-100 px-3 py-2 lg:rounded-full max-sm:max-w-[200px] flex gap-1 justify-center items-center max-sm:h-[60px] rounded-md lg:!text-[13px] text-sm max-sm:text-center w-full lg:w-fit max-sm:mb-3">
                    <span class="bg-gray-600 p-1 rounded-full ">
                        <img src="new-icons/white-icons/cms.png" class="w-4" alt="">
                    </span> Shopify CMS Customization
                </div>

                <div class="tag-item absolute top-28 -left-10 border !border-gray-600 !text-gray-100 px-3 py-2 lg:rounded-full max-sm:max-w-[200px] flex gap-1 justify-center items-center max-sm:h-[60px] rounded-md lg:!text-[13px] text-sm max-sm:text-center w-full lg:w-fit max-sm:mb-3">
                    <span class="bg-gray-600 p-1 rounded-full ">
                        <img src="new-icons/white-icons/admin-panel.png" class="w-4" alt="">
                    </span> Admin Panel Setup
                </div>

                <div class="tag-item absolute top-5 -right-5 border !border-gray-600 !text-gray-100 px-3 py-2 lg:rounded-full max-sm:max-w-[200px] flex gap-1 justify-center items-center max-sm:h-[60px] rounded-md lg:!text-[13px] text-sm max-sm:text-center w-full lg:w-fit max-sm:mb-3">
                    <span class="bg-gray-600 p-1 rounded-full ">
                        <img src="new-icons/white-icons/dynamic.png" class="w-4" alt="">
                    </span> Dynamic Product Catalog
                </div>
                ...
                <div class="tag-item absolute bottom-36 -right-5 border !border-gray-600 !text-gray-100 px-3 py-2 lg:rounded-full max-sm:max-w-[200px] flex gap-1 justify-center items-center max-sm:h-[60px] rounded-md lg:!text-[13px] text-sm max-sm:text-center w-full lg:w-fit max-sm:mb-3">
                    ...
                    </span> Travel Store Integrations
                </div>
