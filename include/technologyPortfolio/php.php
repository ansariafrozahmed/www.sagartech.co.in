...
$slides = array(
  ...
  array(
    ...
    'web_title' => 'BS Auto',
    'desc' => 'BS Auto is a dynamic and user-friendly website designed to showcase automotive services and offerings. Built using Bootstrap for responsive design and PHP for seamless functionality, the site provides a smooth browsing experience across all devices. Whether you are exploring vehicle options, seeking maintenance solutions, or learning more about BS Auto services, everything is just a few clicks away. The site is crafted with performance and simplicity in mind, delivering reliable information and easy navigation to enhance user satisfaction.'
  ),
  array(
    'type' => 'Calalogue',
    'image' => './portfolio-mockups/catalogue/powerplay.webp',
    'web_title' => 'Powerplay',
    'desc' => "Powerplay is a dynamic and user-friendly web application built using Bootstrap and PHP. Designed for performance and responsiveness, Powerplay delivers a seamless experience across devices. Whether you're managing content, interacting with users, or scaling your online presence, Powerplay offers a robust foundation with clean design and efficient functionality. With its lightweight architecture and modern interface, it ensures fast loading times and easy customization, making it an ideal solution for personal projects or professional deployments."
  ),
);
?>
<style>
...
<div class="main-div-portfolio">
  <h2 class="portfolio-heading">Our <span style="color: #ff0808">Projects on PHP</span></h2>
