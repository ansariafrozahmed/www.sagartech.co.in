...
if(isset($_POST['grap_submit'])) {
    $graphic = $_POST['grap_name'];
 
  $countfiles = count($_FILES['files']['name']);
 if($graphic == 'logo') {
    $query = "INSERT INTO images (img_act_id,img_tag) VALUES(1,?)";
 }
 else if($graphic == 'client') {
    $query = "INSERT INTO images (img_act_id,img_tag) VALUES(7,?)";
 }
 else if($graphic == 'poster') {
    $query = "INSERT INTO images (img_act_id,img_tag) VALUES(2,?)";
 }
 else if($graphic == 'pamplet') {
    $query = "INSERT INTO images (img_act_id,img_tag) VALUES(3,?)";
 }
 else if($graphic == 'sticker') {
    $query = "INSERT INTO images (img_act_id,img_tag) VALUES(4,?)";
 }
 else {
...
if($graphic == 'logo') {
    $imgloc = '../images/logo/'.$filename;
 }
 else if($graphic == 'client') {
    $imgloc = '../images/logo/'.$filename;
 }
 else if($graphic == 'poster') {
    $imgloc = '../images/posters/'.$filename;
 }
 else if($graphic == 'pamplet') {
    $imgloc = '../images/pamplets/'.$filename;
 }
 else if($graphic == 'sticker') {
    $imgloc = '../images/stickers/'.$filename;
 }
...
else if(isset($_POST['grap_update'])) {
        
        $act_id   = $_POST['img_id'];
        $img_act_id = $_POST['img_act_id'];
        $act_name = $_POST['grap_name'];
...
<head>
<meta charset="utf-8">
<title>Graphic Design - Backoffice</title>
                      ...
                      <h6 class="bigstats"><?php //echo $statusMsg;?>Image upload section : upload images as per the guide line given by developer</h6>
                        ...
                        <fieldset>	
                          <div class="control-group">											
                            <label class="control-label" for="act_name">Select Graphical Work</label>
                            <div class="controls">
                              <select class="span2" id="graphic" name="grap_name">
                          ...
                          <div class="control-group">											
                            <label class="control-label" for="act_name">Images</label>
                            <div class="controls">
                              <input type="file" class="span3" id="post_img" name="files[]"  multiple>
                            </div> <!-- /controls -->				
                          </div> <!-- /control-group -->
                          <div class="form-actions">
    											<button type="submit" name="grap_submit" class="btn btn-primary">Add</button>
    										</div> <!-- /form-actions -->
                        </fieldset>
                      </form>
                    </div>
        ...
        <div class="span6">
                    ...
                    <label class="control-label" for="act_name">Select Graphical Work</label>
                        <div class="controls">
                          <select class="span2" id="grapShow" name="grap_name">
                              ...
                              <option value="pamplet">Pamplets</option>
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                    ...
                    <h3 id="myModalLabel">Wants to delete this Portfolio?</h3>
                </div>
                <div class="modal-body">
                    <p>This Portfolio will be deleted and can't be undo.</p>
                </div>
        ...
        <div class="span6">
           <div class="widget">
                ...
                <div class="widget-content">
                    <div class="showCont">
                        <div class="shortcuts"> 
                            <a href="portfolio.php" class="shortcut">
...
$(document).ready(function() {
    ...
    $('td #grapDel').click(function() {
          var id = $(this).parent().parent().find(".nr").text();
          $('#modalYes').click(function(){
             window.location.href = "include/del_data.php?grap_id="+id;
          });
      });
